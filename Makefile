...
openapi/generate: openapi/fetch
	@# check if oapi-codegen is installed
	@[ -x "$(shell command -v oapi-codegen)" ] || echo 'please install oapi-codegen: go install github.com/deepmap/oapi-codegen/cmd/oapi-codegen'
	@# generate the code
